-- create with: mysqldump --defaults-extra-file=/home/patrick/.mysql_cnf --no-data killelea | perl -p -e 's/ AUTO_INCREMENT=\d+//' > schema.sql
...
CREATE TABLE `comments` (
  ...
  `comment_browser_hash` varchar(40) DEFAULT NULL,
...
CREATE TABLE `newslinks` (
  `newslink_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `newslink_url` varchar(255) NOT NULL,
  `newslink_title` varchar(255) NOT NULL DEFAULT 'needs title',
  `newslink_post_id` bigint(20) unsigned NOT NULL,
  `newslink_pubdate` date DEFAULT NULL,
  `newslink_display_order` tinyint(2) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `user_stripe_id` varchar(40) DEFAULT NULL,
  `user_stripe_subscription` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
-- Dump completed on 2018-03-26 18:29:38
